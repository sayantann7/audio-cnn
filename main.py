...
class AudioClassifier:
    ...
    def inference(self, request: InferenceRequest):
        ...
        if sample_rate != 441000:
            audio_data = librosa.resample(y=audio_data, orig_sr=sample_rate, target_sr=441000)
        ...
        with torch.no_grad():
            ...
            for name, tensor in feature_maps.items():
                if tensor.dim()==4: # [batch_size, channels, height, widht]
...
def main():
    ...
    print("URL of inference endpoint:", url)
