...
class ESC50Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if waveform.shape[0]>1:
            waveform = torch.mean(sample_rate, dim=0, keepdim=True)
...
def train():
    ...
    test_dataloader = DataLoader(val_dataset, batch_size=32, shuffle=True, pin_memory=True)
    ...
    optimizer = optim.AdamW(model.parameters(), lr=0.005, weight_decay=0.1)
